...
export class CombatSystem {
   ...
   * Called by the AI tick when a mob is in chase range.
   */
  processMobAttack(
    mob: MobInstance,
    ...
    const playerStats = this.getPlayerStats(playerSessionId);
    const damage = calculateDamage(mob.config.baseAttack, mob.config.level, playerStats.defense);
